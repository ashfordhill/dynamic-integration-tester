...
import { selectSelectedFunction, removeFunction, setConsoleOutput, setEditorOpen } from '../../store/functionsSlice';
...
export const FunctionActionButtons = () => {
  ...
  return (
    <Box mt={2}>
      ...
      <Button variant="contained" color="success" fullWidth onClick={handleExecuteFunction} disabled={!selectedFunction}>
        Execute Function
      </Button>
    </Box>
  );
